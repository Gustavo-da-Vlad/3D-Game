...
class Sprites:
    def __init__(self):
        self.sprite_types = {
            'Caco': [pygame.image.load(f'sprites/Caco/{i}.png').convert_alpha() for i in range(8)]
        }
        self.list_of_object = [
            SpriteObject(self.sprite_types['Caco'], False, (7.1, 4.1), 1.2, 0.9)
            #SpriteObject(self.sprite_types['Caco'], False, (5.9, 2.1), 1.2, 0.9)
        ]
